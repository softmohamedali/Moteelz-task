...
class _ApiClient implements ApiClient {
  _ApiClient(
    ...
    baseUrl ??= 'https://stage-api-v2.moteelz.com/api/v1';
  }
  ...
  @override
  Future<WalletDetailResponse> getWalletDetails(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WalletDetailResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
